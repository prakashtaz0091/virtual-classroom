...
class ClassRoom(models.Model):
    teacher = models.ForeignKey(
        "account.User", on_delete=models.CASCADE, related_name="classrooms"
    )
...
class Submission(models.Model):
    ...
    grade = models.CharField(
        max_length=5, choices=SUBMISSION_GRADES, null=True, blank=True
    )
...
class BoughtFile(models.Model):
    user = models.ForeignKey(
        "account.User", on_delete=models.CASCADE, related_name="bought_files"
    )
